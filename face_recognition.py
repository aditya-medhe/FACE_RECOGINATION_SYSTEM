...
class Face_Recognition:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:college_images\face_detector1.jpg")
        img_top = img_top.resize((950, 700), Image.LANCZOS)
        ...
        # button
        b1_1 = Button(f_lbl, text="Face Recognition", cursor="hand2", font=("times new roman", 18, "bold"), bg="white", fg="black", command=self.face_recog)
        b1_1.place(x=250, y=610, width=200, height=40)
    ...
    # face recognition
    def face_recog(self):
        def draw_boundry(img, classifier, scaleFactor, minNeighbhors, color, text, clf):
            ...
            for (x, y, w, h) in features:
                ...
                if confidence > 77:
                    ...
                    cv2.putText(img, f"course:{n}", (x, y - 30), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 3)
